...
export const PAGE_TEMPLATE = [
  ...
  { element: 'Meta Description',            spec: '160 chars. Treatment, location, doctor name, CTA.',            schema: 'None',           content: 'Include \'Dr. Vineeth MB\' and \'Book Free Consultation\'. Trigger SERP clicks.', evidence: 'All major hospital sites — conversion-optimised meta descriptions' },
  ...
  { element: 'H2 — What is [Treatment]?',   spec: '40-60 word direct answer. Plain English. No jargon.',         schema: 'FAQPage Q&A',    content: 'This exact format wins Google AI Overview citations and voice answers.', evidence: 'Manipal: \'What are Stem Cells?\' — plain definition, directly answers query' },
  ...
  { element: 'H2 — Benefits',               spec: '4-6 benefits. Short, scannable. Icons or bullets.',            schema: 'None',           content: 'Conversion-optimised section. Patient outcomes, not features.', evidence: 'All top performers have this section' },
  { element: 'H2 — [Treatment] vs. Alternatives', spec: 'Comparison table: treatment vs surgery vs medication.', schema: 'None',           content: 'Positions Regencare without making prohibited NMC superiority claims.', evidence: 'Kokilaben PRP page: PRP vs Steroid vs Surgery vs Hyaluronic Acid' },
  { element: 'H2 — Cost / What to Expect',  spec: "Price range or factors. 'Starting from ₹X' acceptable.",     schema: 'FAQPage',        content: "Captures 'GFC therapy cost Kerala' (170/mo) — currently no strong answer.", evidence: 'DermaVue: only local competitor listing pricing. Gap for all others.' },
  { element: 'H2 — Why Regencare?',         spec: 'Dr. Vineeth MB credentials + branch locations + unique claims.', schema: 'None',        content: "Differentiates from all 10 local clinics. Must include: 'South India's first', MS Ortho credentials, multi-branch.", evidence: "Every hospital has this section. Every local clinic lacks it." },
  { element: 'H2 — FAQs (10-12 Q&A)',       spec: 'Direct question-answer. 40-60 words per answer.',             schema: 'FAQPage',        content: '10 Q&As = People Also Ask box eligibility for all 10 questions.', evidence: 'Manipal, Kokilaben, Apollo, Chaitanya, Stem Cell Care India' },
  { element: 'CTA Block (×3)',               spec: 'Book Appointment + WhatsApp + Phone',                         schema: 'None',           content: 'Appear at: top of page, after benefits, after FAQs.', evidence: 'DermaVue 3 CTAs, Oliva 4 CTAs, Kokilaben 5 CTAs' },
  ...
  { element: 'Academic Citation',            spec: '1-2 PubMed/peer-reviewed citations per treatment page.',      schema: 'None',           content: "Builds E-E-A-T. Required for Google's YMYL content quality assessment.", evidence: 'Chaitanya: 6 PubMed citations — highest found. Manipal: 1 PubMed link' },
  { element: 'Internal Links (5+)',          spec: 'Link to: treatments, conditions, doctor profile, branches.',  schema: 'None',           content: 'Passes authority to new pages. Reduces bounce. Hub-spoke architecture.', evidence: 'Apollo Spectra: 6 related treatment links in sidebar' },
  ...
  { element: 'Schema Block (JSON-LD)',        spec: 'MedicalProcedure + FAQPage + Person + LocalBusiness + Breadcrumb', schema: 'All types', content: "Single JSON-LD block in <head>. Links all entities via @id.", evidence: 'Apollo: full schema graph. DermaVue: 4 schema types. Regencare: partial only' },
]
